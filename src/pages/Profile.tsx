...
import testProfile from '../assets/user-front-side-with-white-background.jpg';
            ...
            <div className="profile-card-container" style={{ backgroundColor : dark ? 'black' : 'white' }}>
                <Card className="profile-card" style={{ backgroundColor : dark ? 'black' : 'white', color : dark ? 'white' : 'black' }}>
                    ...
                    <Card.Body>
                        ...
                        <Card.Text>
                            <strong>Role:</strong> {user.doctor ? 'Admin' : 'Patient'}
                        </Card.Text>
                        <Card.Text>
                        ...
                        <Button
                            ...
                            style={{background: '#18392b', outline: 'none', border: 'none'}}
                        >
                            Edit Profile
                        </Button>
                    </Card.Body>
